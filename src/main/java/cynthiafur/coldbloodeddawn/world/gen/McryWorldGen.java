package cynthiafur.coldbloodeddawn.world.gen;
...
public class McryWorldGen implements IWorldGenerator{
	
	public final WorldGenMinable McryOverworldGen;
	
	public McryWorldGen() {
		
		McryOverworldGen = new WorldGenMinable(ModBlocks.ruby_ore.getDefaultState(), 5, BlockMatcher.forBlock(Blocks.STONE));
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
		...
		case OVERWORLD:
			genStandard(McryOverworldGen, world, random, chunkX, chunkZ, 10, 0, 200);
			break;
